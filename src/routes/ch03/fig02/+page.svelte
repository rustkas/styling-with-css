...
<!--header--> 
<div id="logo"> <img src="/images/stylin_logo1.gif" width="150" height="80" alt="Stylin logo" /> 
...
<!--navigation--> 
<div id="navigation"> 
  <p>Here are some useful links from the web site of the <acronym title="Word Wide Web Consortium">W<sup>3</sup>C</acronym> (World
